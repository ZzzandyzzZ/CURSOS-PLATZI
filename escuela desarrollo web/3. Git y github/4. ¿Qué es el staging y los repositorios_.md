...
### Ejemplo
- Creo un archivo (estado untrucked), lo agrego al staging (git add) cambio su estado a staged, lo modifico (unstaged), le doy git add (staged) y ahora le doy coomit (tracked).
